...
void control(double* r4, double* r5, double* error, double& emax1, double& emax2, double& errormax);
...
int main(void){
  ...
  double r4[4];
  double r5[4];
  double error[4], emax1, emax2, errormax;						//local error = ||z[i]-y[i]||
  ...
  while(t<t1){
   ...
   control(r4, r5, error, emax1, emax2, errormax);
